...
public interface MusicService extends Remote {
    ...
    List<Song> getSongsByName(String name, String token) throws RemoteException;
    ...
    List<Album> getAlbumsByTitle(String title, String token) throws RemoteException;
    ...
    List<Artist> getArtistsByName(String name, String token) throws RemoteException;
