...
public class ArtistsView extends VBox {
    ...
    public ArtistsView(RMIClient rmiClient, int userId, MainAppController mainAppController) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/istream/fxml/content/ArtistsView.fxml"));
        loader.setControllerFactory(param -> new ArtistsViewController(rmiClient, userId, mainAppController));
        loader.setRoot(this);
        loader.load();
