...
public class AuthController {
    ...
    private void switchToLoginView() {
        try {
            Parent loginView = createLoginView(rmiClient, sessionManager);
    ...
    private void switchToRegisterView() {
        try {
            Parent registerView = createRegisterView(rmiClient, sessionManager);
            root.getChildren().clear();
    ...
    public static Parent createLoginView(RMIClient rmiClient, SessionHolder sessionManager) {
        try {
            FXMLLoader loader = new FXMLLoader(AuthController.class.getResource("/com/istream/fxml/content/LoginView.fxml"));
            loader.setControllerFactory(param -> new AuthController(rmiClient, sessionManager));
            return loader.load();
        } catch (Exception e) {
    ...
    public static Parent createRegisterView(RMIClient rmiClient, SessionHolder sessionManager) {
        try {
